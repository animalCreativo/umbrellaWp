          ...
          <div class="top-bar show-for-small-only" id="example-menu" style="height: 100vh;  z-index: 1; /* Sit on top */">
            <div class="top-bar-left" style="height: 100%;">
              <ul class=" dropdown menu" data-magellan data-dropdown-menu id="menuListHeader">
                  <li><a class= "clickMenu" href="#first" >¿Qué es Umbrella?</a></li>
              </ul>
              <ul class=" dropdown menu" data-magellan data-dropdown-menu id="menuListHeader">
                  <li><a class= "clickMenu" href="#second">Modo de acción</a></li>
              </ul>
              <ul class=" dropdown menu" data-magellan data-dropdown-menu id="menuListHeader">
                  <li><a class= "clickMenu" href="#third" >¿Cómo funciona?</a></li>
              </ul>
              <ul class=" dropdown menu" data-magellan data-dropdown-menu id="menuListHeader">
        ...
        <div class="row">
          ...
          <div class="columns small-12 medium-9 show-for-medium" >
            <ul class="menu" data-magellan id="menuListHeader">
                <li><a href="#first" >¿Qué es Umbrella?</a></li>
                <li><a href="#second">Modo de acción</a></li>
                <li><a href="#third" >¿Cómo funciona?</a></li>
                <li><a href="#fourth" >Puntos de Venta</a></li>
                <li><a href="mailto:jsamur@pharmainvesti.cl">Contacto</a></li>
            </ul>
          </div>
        </div>
...
<li class="is-active orbit-slide">
        <figure class="orbit-figure">
          <a href="http://www.umbrellachile.cl/ofertasydescuentos/"><img class="orbit-image show-for-small-only" src="http://www.umbrellachile.cl/ofertasydescuentos/assets/SliderpromoMobile@2x.jpg" alt="Umbrella Intelligent - Protección y reparación de la piel desde su ADN"></a>
          <a href="http://www.umbrellachile.cl/ofertasydescuentos/"><img class="orbit-image show-for-medium-only" src="http://www.umbrellachile.cl/ofertasydescuentos/assets/SliderpromoTablet.jpg" alt="Umbrella Intelligent - Protección y reparación de la piel desde su ADN"></a>
                    ...
                    <nav class="menu-footer-container">
                        <ul id="menu-footer" class="menu footermenu" data-magellan>
                            <li id="menu-item-175" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-175">
                                <a href="#first">¿Qué es Umbrella?</a>
                            </li>
                            <li id="menu-item-98" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-98">
                                <a href="#second">Modo de acción</a>
                            </li>
                            <li id="menu-item-97" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-97">
                                <a href="#third">¿Cómo funciona?</a>
                            </li>
                            <li id="menu-item-97" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-97">
                                <a href="#fourth">Puntos de Venta</a>
                            </li>
                            <li id="menu-item-97" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-97">
